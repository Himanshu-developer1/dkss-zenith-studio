...
const SERVICES = [
  ...
  { icon: Sparkles, title: "Colour Correction / Colour Grading", desc: "Cinematic colour grading and correction that give every frame a premium, editorial finish." },
...
const EXPERIENCE = [
  {
    company: "Gamoft Consultancy Services Pvt. Ltd.",
    role: "Digital Marketing Executive",
    year: "Jul 2024 – Jul 2025",
    location: "Lucknow, India",
    type: "Agency",
    desc: "Led SEO, paid advertising, and lifecycle marketing across multiple real estate and enterprise brands—improving organic visibility, campaign efficiency, and customer engagement.",
    highlights: [
      "Built and executed SEO strategies for Rishita Developers, Godrej Riverine, and Eldeco Trinity, increasing average organic traffic by 30% across client websites.",
      "Managed 2–3 concurrent PPC campaigns across Google Ads, Bing, and Meta Ads, reducing cost-per-click by 20% and improving conversions by 15%+ through audience refinement and creative testing.",
      "Designed and executed email marketing sequences with A/B testing, achieving a 22% open rate, 10% CTR, and 12% higher conversions while growing subscriber lists organically.",
    ],
    stack: ["SEO", "GOOGLE ADS", "META ADS", "EMAIL MARKETING"],
  },
  {
    ...
    type: "Agency",
    desc: "Created brand-focused visual content and managed social media publishing for hospitality, restaurant, and lifestyle brands across multiple digital platforms.",
    highlights: [
      "Managed social media content for Barista, Levelup Hotels & Resorts, Curry King, and STT World, scheduling regular posts across Instagram, Facebook, LinkedIn, and Twitter.",
      "Designed static and animated brand creatives using Photoshop, Canva, and Affinity, contributing to an average of 100–150+ new followers per client each month.",
      "Developed marketing copy and ad scripts for social campaigns, aligning visuals and messaging with each brand's tone and conversion goals.",
    ],
    stack: ["PHOTOSHOP", "CANVA", "AFFINITY", "SOCIAL MEDIA"],
  },
  {
    company: "Reerocket",
    ...
    type: "Creator Studio",
    desc: "Delivered high-volume creative production for multiple brands, owning complete video editing workflows from concept to final delivery.",
    highlights: [
  ...
  {
    company: "Rahe Solution (via RaheBoost AI Platform)",
    role: "Social Media Manager & Creative Lead",
    year: "Feb 2026 – Jun 2026",
    location: "Texas, USA · Remote",
    type: "International",
    desc: "Led creative production and AI-powered content operations for US hospitality and restaurant brands, managing strategy, publishing, and performance across multiple client accounts.",
    highlights: [
      "Grew client social accounts from 90 to 1,000+ followers within 2 months through consistent content strategy, high-retention Reels, and platform-native formats for US hospitality and F&B brands.",
      "Produced short-form content for Desi Comedy Club and House of Chettinad (Texas), reaching 2,000+ organic views per post.",
      "Managed all creative operations through the RaheBoost AI platform including content calendars, approval workflows, multi-channel publishing, and performance tracking.",
